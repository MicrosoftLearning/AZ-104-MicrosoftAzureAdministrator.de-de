...
1. Laden Sie die Labdateien **\\Allfiles\\Labs\\11\\az104-11-vm-template.json** auf Ihren Computer herunter.
...
1. Suchen Sie die Datei **\\Allfiles\\Labs\\11\\az104-11-vm-template.json**, und wählen Sie diese aus. Wählen Sie anschließend **Öffnen** aus.
...
1. Wählen Sie neben Ihrem virtuellen Computer die Option **Aktivieren** aus.

1. Übernehmen Sie die Standardeinstellungen, und wählen Sie **Überprüfen und aktivieren** und anschließend **Aktivieren** aus.  
...
1. Setzen Sie die Arbeit an Ihrer Benachrichtigung fort. Wechseln Sie zur Registerkarte **Aktionen**, und wählen Sie **Aktionsgruppen verwenden** und anschließend auf dem Blatt **Aktionsgruppe auswählen** die Option **Aktionsgruppe erstellen** aus.
...
1. Wechseln Sie nach Erstellung der Aktionsgruppe zur Registerkarte **Weiter: Details >**, und geben Sie für jede Einstellung die folgenden Werte ein.
...
1. Klicken Sie auf **Weiter: Zeitplanung >**.
...
1. Klicken Sie auf **Weiter: Details >**, und geben Sie diese Einstellungen ein:
